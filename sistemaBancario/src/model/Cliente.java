...
public class Cliente {
   ...
   public Cliente(String nome, String cpf, String profissao,
           Endereco endereco, ContaBancaria conta){
   ...
   public Cliente(String nome, String cpf, String profissao,
          String rua, int numeroEndereco, String cep, String cidade,
          String estado,
       ...
       Endereco endereco = new Endereco(rua, numeroEndereco, cep, cidade, estado);
